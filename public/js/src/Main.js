...
function render()
{
	...
	// handtracking.tick();
	powerUpsHistory.push({time: new Date().getTime(), slowMo, isAutomation, ultraSlice, transparency, isLlamas})
	if (multiplayer){
...
function initEvents() {
	...
	if (multiplayer) {
		...
		document.body.addEventListener("keydown", (e) => {if(e.keyCode === 9){gameOver()}}, true);
